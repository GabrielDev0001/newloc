...
export const Route = createFileRoute("/diaria")({
  head: () => ({
    meta: [
      { title: `Aluguel por diária — ${BRAND.name}` },
      { name: "description", content: "Alugue o carro por diária, com opção de KM livre. Manutenção e gestão de multas inclusas." },
      { property: "og:title", content: `Aluguel por diária — ${BRAND.name}` },
      { property: "og:description", content: "Diária flexível, com opção de KM livre e sem contrato longo." },
    ],
  }),
        ...
        <section className="border-b border-border bg-hero text-white">
          <div className="container mx-auto px-4 py-16 md:py-20">
            ...
            <h1 className="mt-3 max-w-2xl font-display text-4xl font-bold leading-tight md:text-5xl">
              Alugue por diária, sem contrato longo
            </h1>
            <p className="mt-4 max-w-xl text-white/80">
              Retire hoje e devolva quando quiser. Com opção de KM livre, manutenção e
              gestão de multas inclusas.
            </p>
          </div>
        </section>
        ...
        <section className="border-b border-border py-14">
          <div className="container mx-auto px-4">
            <div className="grid gap-6 md:grid-cols-3">
              {[
                { icon: CalendarDays, t: "Flexível", d: "Você escolhe por quantos dias fica com o carro." },
